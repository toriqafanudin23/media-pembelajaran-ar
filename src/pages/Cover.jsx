        ...
        <div className="relative z-10">
          ...
          <div className="w-full flex justify-center mb-4 animate-fade-in">
            <button
              ...
              className="group relative px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl text-base font-bold shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-3"
            >
              <svg
                className="w-5 h-5"
                fill="none"
