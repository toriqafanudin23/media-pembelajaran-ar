  ...
  return (
    ...
    >
      <a-assets>
        <a-asset-item
          id="model"
          src="https://hmgdlcwzpmbgvfpaiylz.supabase.co/storage/v1/object/public/images/animasi/kubus-warna-2-anim.glb"
        ></a-asset-item>
      </a-assets>

      <a-marker
        type="pattern"
        url="https://hmgdlcwzpmbgvfpaiylz.supabase.co/storage/v1/object/public/images/markers/pattern-objek1.patt"
      >
        <a-entity
          gltf-model="#model"
          scale="0.5 0.5 0.5"
...
const SimulasiARjs = ({ model3D, scale, nama, buttonActive = true }) => {
